...
int mmc_attach_sd(struct mmc_host *host)
{
	...
	host->ios.vtf_ocp = false;
	host->ios.ocp_gpio = mmc_gpio_ocp_status(host);
	pr_warn("%s:%s vtf_ocp = %s,gpio_cd = %d.\n", mmc_hostname(host), __func__, "false", mmc_gpio_ocp_status(host));
