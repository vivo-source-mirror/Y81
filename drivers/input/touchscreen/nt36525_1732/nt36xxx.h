...
/*-- - I2C driver info.-- - */
#define NVT_I2C_NAME "NVT-ts-1732"
...
#if WAKEUP_GESTURE
extern const uint16_t gesture_key_array_1732[];
#endif
...
/*-- - extern structures-- - */
extern struct nvt_ts_data_1732 *ts_1732;

/*-- - extern functions-- - */
extern int32_t CTP_I2C_READ_1732(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
extern int32_t CTP_I2C_WRITE_1732(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
extern void nvt_bootloader_reset_1732(void);
extern int nvt_sw_reset_idle_1732(void);
extern int32_t nvt_check_fw_reset_state_1732(RST_COMPLETE_STATE_1732 check_reset_state);
extern int32_t nvt_get_fw_info_1732(void);
extern int32_t nvt_clear_fw_status_1732(void);
extern int32_t nvt_check_fw_status_1732(void);
#if NVT_TOUCH_ESD_PROTECT
extern void nvt_esd_check_enable_1732(uint8_t enable);
#endif
extern void nvt_stop_crc_reboot_1732(void);
