...
#if defined(CONFIG_VIVO_CHARGING_NEW_ARCH) && defined(CONFIG_MTK_DISABLE_GAUGE)
extern int vivo_get_dynamic_period(int first_use, int first_wakeup_time, int battery_capacity_level);
#endif
...
#if defined(CONFIG_VIVO_CHARGING_NEW_ARCH) && defined(CONFIG_MTK_DISABLE_GAUGE)
	if (sec > vivo_get_dynamic_period(first_use, first_wakeup_time, battery_capacity_level))
		sec = vivo_get_dynamic_period(first_use, first_wakeup_time, battery_capacity_level);
#endif
