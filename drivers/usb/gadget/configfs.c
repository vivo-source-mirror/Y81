...
bool usbisconfigured = false;
bool usb_is_configured(void)
{
        return usbisconfigured;
}
EXPORT_SYMBOL(usb_is_configured);
void clear_usb_is_configured(void)
{
	usbisconfigured = false;
}
EXPORT_SYMBOL(clear_usb_is_configured);
