...
void mtk_usb_phy_tuning(void)
{
	...
	if (mtk_musb->is_host_mode) {
		...
		usb20_phy_debugfs_write_width3(OFFSET_RG_USB20_VRT_VREF_SEL, SHFT_RG_USB20_VRT_VREF_SEL, "101");
		...
		/* USB_DRIVING_CAPABILITY */
		usb20_phy_debugfs_write_width3(OFFSET_RG_USB20_TERM_VREF_SEL, SHFT_RG_USB20_TERM_VREF_SEL, "111");
		usb20_phy_debugfs_write_width3(OFFSET_RG_USB20_VRT_VREF_SEL, SHFT_RG_USB20_VRT_VREF_SEL, "110");
