...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{REGFLAG_DELAY, 10, {} },
	{0xFB, 1, {0x01} },
	{0x00, 1, {0x80} },//12bit display brightness resolution
	{0x07, 1, {0x00} },
	{0x08, 1, {0x01} },
	{0xFF, 1, {0x23} },
	{REGFLAG_DELAY, 10, {} },
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch = 112;   //160
...
#endif
#ifdef CONFIG_MTK_LCM_MIPI_CLK_CONTROL_RU
	if (rf_hw_id == 1) {
		params->dsi.horizontal_backporch = 152;
		params->dsi.horizontal_frontporch = 122;
	...
	printk("%s 1803 rf_hw_id PLL_CLOCK %d\n", __func__, params->dsi.PLL_CLOCK);
#endif
#ifdef CONFIG_VIVO_LCM_PD1732DF_CONTROL
	if (product_hw_id == 1)
		params->dsi.PLL_CLOCK = 359;
...
struct LCM_DRIVER nt36525_hdp_dsi_vdo_truly_lm3697_622_lcm_drv = {
	.name = "nt36525_hdp_dsi_vdo_truly_lm3697_622_drv",
