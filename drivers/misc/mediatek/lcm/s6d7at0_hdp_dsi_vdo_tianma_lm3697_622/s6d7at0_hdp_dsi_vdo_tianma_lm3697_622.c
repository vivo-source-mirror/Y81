...
static struct LCM_setting_table init_setting_12bit[] = {
	{REGFLAG_DELAY, 1, {} },
	{0xF0, 2, {0x5A, 0x5A} },
	{0xC0, 15, {0x03, 0x01, 0x54, 0x01, 0x00, 0xFF, 0x00, 0x04, 0x0F, 0xFF, 0x70, 0x40, 0x88, 0xE6, 0xA5} },
	{0xB0, 1, {0x07} },
	{0xC0, 1, {0x04} },
	{0xB0, 1, {0x0C} },
	{0xF2, 1, {0x84} },
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	if (product_hw_id == 1) {
		...
		if (level == 0)
			dimming_enable = 0;
		//pr_err("[LCM]%s,s6d7at0 backlight: level = 0x%x\n", __func__, level);
		level = level << 4;
		level = level | 0x0001;
...
struct LCM_DRIVER s6d7at0_hdp_dsi_vdo_tianma_lm3697_622_lcm_drv = {
	.name = "s6d7at0_hdp_dsi_vdo_tianma_lm3697_622_drv",
