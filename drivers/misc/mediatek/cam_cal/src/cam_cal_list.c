...
/*Below is commom sensor */
	{S5K3L6XXL1_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_vivo_cid},
	{S5K3L6XX_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_vivo_cid},
	{OV13855_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
	{S5K4H8YX_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_vivo_cid},//zyf add for sub camera S5K4H8_SENSOR_ID
...
unsigned int cam_cal_check_mtk_vivo_cid(struct i2c_client *client, cam_cal_cmd_func readCamCalData)
{
	unsigned int calibrationID = 0, ret = 0;
	int j = 0;
