...
extern bool gauge_get_battery_plugout(void);
extern int gauge_get_hwocv(void);
extern int gauge_get_zcv(int *zcv);
extern int gauge_get_zcv_current(int *zcv_current);

extern int gauge_reset_hw(void);
extern void gauge_set_rtc_ui_soc(int rtc_ui_soc);
extern void gauge_get_rtc_ui_soc(int *rtc_ui_soc);
extern int gauge_get_bat_avg_current(bool *valid);
extern void battery_callback(unsigned long event);
