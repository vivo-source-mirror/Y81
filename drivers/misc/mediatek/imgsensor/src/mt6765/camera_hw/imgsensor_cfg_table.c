...
struct IMGSENSOR_HW_CFG imgsensor_custom_config1[] = {
	{	
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			{IMGSENSOR_HW_ID_MCLK, IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD}, //for proj2
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DVDD},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_PDN},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_RST},
...
/*PD1732DF_EX*/
struct IMGSENSOR_HW_CFG imgsensor_custom_config2[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config3[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#endif
#if defined(OV02C10_MIPI_RAW)
		{
			SENSOR_DRVNAME_OV02C10_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{DOVDD, Vol_1800, 1},
				{AVDD, Vol_2800, 1},
...
#endif
#if defined(S5K4H8YX_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H8YX_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_1800, 1},
...
#if defined(S5K3L6XXL1_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3L6XXL1_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_1800, 1},
