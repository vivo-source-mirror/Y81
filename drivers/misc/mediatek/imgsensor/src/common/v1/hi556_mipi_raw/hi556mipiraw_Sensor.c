...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		.pclk = 167200000,				//record different mode's pclk
...
extern int vivo_sub_otp_read(void);
int vivo_sub_otp_read_when_power_on_hi556;
extern otp_error_code_t SUB_OTP_ERROR_CODE;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0b12, 0x006c);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0f30, 0xd155);
			...
			do {
				*sensor_id =return_sensor_id();
				...
				/*vivo hope add for AT cammand end*/
					...
					sensor_init();
					/*vivo caofeixiang add for CameraEM otp errorcode*/
					LOG_INF("add:start read eeprom ---vivo_sub_otp_read_when_power_on_hi556 = %d\n", vivo_sub_otp_read_when_power_on_hi556);
					vivo_sub_otp_read_when_power_on_hi556 = vivo_sub_otp_read();
					LOG_INF("add:end read eeprom ---vivo_sub_otp_read_when_power_on_hi556 = %d,SUB_OTP_ERROR_CODE =%d\n", vivo_sub_otp_read_when_power_on_hi556,SUB_OTP_ERROR_CODE);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	break;
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  SUB_OTP_ERROR_CODE:%d \n", *feature_data,SUB_OTP_ERROR_CODE);
			switch (*feature_data) {
				case 0:    //info type: otp state
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = SUB_OTP_ERROR_CODE;//otp_state
					break;
			}
			break;
