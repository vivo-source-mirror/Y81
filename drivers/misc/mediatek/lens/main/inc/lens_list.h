...
#define DW9716AF_SetI2Cclient DW9716AF_SetI2Cclient_Main
#define DW9716AF_Ioctl DW9716AF_Ioctl_Main
#define DW9716AF_Release DW9716AF_Release_Main
extern int DW9716AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9716AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
